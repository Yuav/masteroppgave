...
For intrinsic silicon, there has been extensive research into photoluminescence. An important study is \cite{dean67}, which characterize intrinsic silicon, as well as doped silicon, in terms of photoluminescence. Intrinsic characteristics from this study can be found in figure \ref{fig:SiPL} in the appendix. An overview over relevant photoluminescence spectra has been compiled, and can be found in table \ref{energy_bands} in the appendix. Relevant spectra from literature related to impurities and defects, can also be found in the appendix. The main, band to band photoluminescence can be accurately described by 
