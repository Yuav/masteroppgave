...
\begin{equation}
\frac{atoms/cm^{-3}}{ppbw} = \frac{10^{-9}\cdot 6.022\cdot10^23[mol^{-1}]\cdot 2.3290[g\cdot~cm^{-3}]}{10.811~[g/mol]} = 1.3\cdot10^{14}
\label{eq:ppbwB}
\end{equation}
...
\begin{equation}
ppbw = \frac{[atomic mass of element]}{[atomic mass of Si]}
\label{eq:ppba}
\end{equation}

so that 1~ppba boron in silicon is

\begin{equation}
ppbw = \frac{1\cdot10.811}{28.0855} = 0.385
\label{eq:ppbaB}
\end{equation}

and 1~ppba phosphorus

\begin{equation}
ppbw = \frac{1\cdot30.97376}{28.0855} = 1.103
\label{eq:ppbaP}
\end{equation}
