...
Silicon has different absorption lengths for different wavelengths. Absorption length is about 1~$µ$m for 532~nm laser excitation, which means that precipitates, and defects deeper in the sample won't be detected. Like iron precipitates in \cite{gundel09}. This limitation might be overcome by an excitation laser with a longer wavelength, and consequently absorption length in silicon. For 1125nm, the absorption depth is nearly 200~$µ$m \cite{laserdybde}. Compared to absorption length for 532nm, 1125nm reach 200 times deeper into the sample.
