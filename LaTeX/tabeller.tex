...
1.092eV & Si:B(BE)$^{TO}$ & 4.2K & Si:B bound exciton & \cite{drozdov76,sauer73,sauer74} \\ \hline
1.0921eV & Sb$^{TO}$ & 15K & Antimony doping TO & \cite{dean67} \\ \hline
1.0924eV & B$^{TO}$ & 15K & Boron doping TO & \cite{dean67} \\ \hline
1.093eV & B$_{TO}$ & 4.2K & TO phonon replica of Boron bound exciton & \cite{sugimoto07,inoue07} \\ \hline
1.097eV & I(FE)$^{TO}$ & 26K & Transversal Optical/Free exciton & \cite{dean67,hammond75,drozdov03} \\ \hline
1.0972eV & Si:B(FE) & 2K & Free exciton & \cite{sauer73} \\ \hline
1.1365eV & I(FE)$^{TA}$ & 26K & Transversal Acoustic & \cite{hammond75,dean67} \\ \hline
1.147eV & Si:P(BE)$^{TO}$ & 2K & Si:P bound exciton replica & \cite{sauer73,sauer74} \\ \hline
1.150eV & Si:P(BE) & 2K & Si:P bound exciton & \cite{sauer73} \\ \hline
1.1545eV & I$^0$/I(FE) & 26K & No phonon & \cite{dean67} \\ \hline
2.786eV & $^48_C$Ti & 4.2K & C line Ti isotope 48 impurity in 6H SiC & \cite{kemenade74} \\ \hline
2.820eV & $^48_B$Ti & 4.2K & B$^0$ line Ti isotope 48 impurity in 6H SiC & \cite{kemenade74,wagner2002} \\ \hline
2.85eV & $^48$Ti & 4.2K & Ti isotope 48 impurity in 4H SiC & \cite{patrick74} \\ \hline
2.861eV & $^48_A$Ti & 4.2K & A$^0$ line Ti isotope 48 impurity in 6H SiC & \cite{kemenade74,wagner2002} \\ \hline
...
\begin{figure}%
\centering
\includegraphics[width=10cm]{Ti_4H_SiC}%
\caption{Titanium PL from Ti contaminated 4H SiC}%
\label{fig:Ti4HSiC}%
\end{figure}
