...
1.092eV & BE1 & 4.2K & Boron bound exciton & \cite{drozdov76,sauer73,sauer74} \\ \hline
...
1.0970eV & I$^{TO}$/FE & 26K & Transversal Optical/Free exciton & \cite{dean67,hammond75,drozdov03} \\ \hline
1.1365eV & I$^{TA}$/LO/FE & 26K & Transversal Acoustic/Longitudinal/FE & \cite{hammond75,dean67} \\ \hline
1.147eV & BE2 & 2K & Phosphorous bound exciton & \cite{sauer73,sauer74} \\ \hline
...
\caption{Intrinsic/low doped ($2\cdot10^{14}cm^{-3}$ P atoms) Si PL specter from \cite{dean67}}%
\label{fig:SiPL}%
\end{figure}
