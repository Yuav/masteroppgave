...
Fe bound with boron is also known to give rise to photoluminescence \cite{mohring83}. The sample used in the article had  10^13 to 10^16cm^-3 boron doping concentration. The article doesn't mention how many Fe impurity atoms that's introduced into the sample, but it's done by high temperature diffusion, and assumed to be considerably larger than for all the samples in this study. 
