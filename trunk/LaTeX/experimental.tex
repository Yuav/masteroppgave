...
R6-Q3-210 & Polysilicon, good quality & Clean feedstock & Siemens process \\ \hline
ES1-Q3-201 & Large amount of P and B & Dirty feedstock & From Elkem \cite{hystad09} \\ \hline
MH2-Q3-201 & Same as ES1 with added Cr & Dirty feedstock & From Elkem \cite{hystad09} \\ \hline
\end{tabular}
...
%%%%% Fe, Al?, Ti - 2.6\cdot10$^{15}$~atoms/cm$^3$
...
MH2 are neither n og p-type, however there is enough boron atoms to saturate chromium by forming CrB pairs. Chromium atoms are in the order of 10$^{14}$~atoms/cm$^3$ which is similar to that in \cite{conzelmann82}. Expected photoluminescence spectra is therefor expected to be similar. (See figure \ref{fig:CrBSiPL} in appendix \ref{appendix:tabeller}). With most of the boron bound with chromium, it is likely that the boron lines will be severely reduced compared to ES1, and not detectable.
