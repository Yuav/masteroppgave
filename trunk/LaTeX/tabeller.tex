...
0.8432eV & CrB$^0$ & 4.2K & Cr-B pair no-phonon & \cite{conzelmann82} \cite{conzelmann83} \\ \hline
...
0.9537eV & Defect & & Iron precipitate & \cite{gundel09} \\ \hline
...
2.820eV & $^48_B$Ti & 4.2K & B$^0$ line Ti isotope 48 impurity in 6H SiC & \cite{kemenade74} \cite{wagner2002} \\ \hline
2.85eV & $^48$Ti & 4.2K & Ti isotope 48 impurity in 4H SiC & \cite{patrick74} \\ \hline
2.861eV & $^48_A$Ti & 4.2K & A$^0$ line Ti isotope 48 impurity in 6H SiC & \cite{kemenade74} \cite{wagner2002} \\ \hline
...
\begin{figure}%
\includegraphics[width=15cm]{Ti_4H_SiC}%
