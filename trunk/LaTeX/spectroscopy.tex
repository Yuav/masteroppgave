...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{temp_dependance}%
\caption{Temperature dependence of the intrinsic energy gap from \cite{bludau74}}%
\label{fig:temp_dependance}%
\end{figure}
...
\begin{figure}%
\centering
\includegraphics[width=\columnwidth]{temp_broadening}%
\caption{Normalized photoluminescence spectra of a 0.5~\ohm cm boron doped Si sample with surface passivation by a 100~nm thermal oxide, recorded at different temperatures from \cite{alex96}}%
\label{fig:temp_broadening}%
\end{figure}
