...
Silicon has different absorption lengths for different wavelengths. Absorption length is about 1~$µ$m for 532~nm laser excitation, which means that precipitates, and defects deeper in the sample like iron precipitates won't be detected \cite{gundel09}. By comparison, 800~nm, reach 12~$µ$m into the sample, and 1125~nm reach as far down as 200~$µ$m \cite{laserdybde}. This limitation might be overcome by an excitation laser with a longer wavelength, and consequently absorption length in silicon. 
