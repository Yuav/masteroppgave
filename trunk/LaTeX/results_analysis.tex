...
\cite{davies88} state that with excitation powers of 1.5~W/mm$^2$, with the sample at 20~K, it is heated by less than 0.5~K. With a spot size of around 2~$µ$m, there are bound to be issues regarding local heating. Single crystal silicon has maximum thermal conductivity at 30~K, of around 4~W/mmK \cite{glassbrenner64}. A spot diameter of 2$µ$m, with 128~mW excitation energy, as in figure \ref{fig:temperature_fitting}, corresponds to 40~kW/mm$^2$. As silicon has an indirect band gap, nearly all the excitation light intensity is absorbed as heat. 
