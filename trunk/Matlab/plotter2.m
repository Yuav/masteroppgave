...
plot_result(R6_clean_950mW,2,'ev','30s integrating time','R6 A Area 2 - 30s integration time',fontsize,'b',3);
...
plot_result(R6_clean_400mW,2,'ev','30s integrating time','R6 A Area 2',fontsize,'g',3);
...
plot_result(R6_clean_220mW,2,'ev','30s integrating time','R6 A Area 2',fontsize,'r',3);
...
plot_result(R6_clean_70mW,2,'ev','30s integrating time','R6 A Area 2',fontsize,'k',3);

legend('50 mW', '21 mW', '11.5 mW', '3.7 mW');
print -depsc 'Processed_results\R6-A-Area2-intensities-clean_area-30s';
...
plot_result(R6_GB_400mW,3,'ev','30s integrating time','R6 A Area 1 - 30s integration time',fontsize,'b',7);
...
plot_result(R6_GB_220mW,3,'ev','30s integrating time','R6 A Area 1',fontsize,'r',7);
...
plot_result(R6_GB_180mW,3,'ev','30s integrating time','R6 A Area 1',fontsize,'k',7);

legend('21 mW', '11.5 mW','9.7 mW');
print -depsc 'Processed_results\R6-A-Area1-intensities-grain_boundary-30s';
...
plot_result(ES1_clean_220mW,4,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'b',3);
...
plot_result(ES1_clean_180mW,4,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'g',3);
...
plot_result(ES1_clean_80mW,4,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'m',3);
...
plot_result(ES1_clean_40mW,4,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'c',3);
...
plot_result(ES1_clean_20mW,4,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'y',3);
...
plot_result(ES1_clean_10mW,4,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'k',3);

legend('11.5mW','9.7 mW','4.3 mW','2.15 mW','1.08 mW');
print -depsc 'Processed_results\ES1-C-Area2-intensities-clean_area-30s';
...
plot_result(ES1_GB_840mW,5,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'b',3);
...
plot_result(ES1_GB_400mW,5,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'g',3);
...
plot_result(ES1_GB_220mW,5,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'c',3);
...
plot_result(ES1_GB_180mW,5,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'m',3);
...
plot_result(ES1_GB_80mW,5,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'y',3);
...
plot_result(ES1_GB_40mW,5,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'k',3);

legend('45 mW','21 mW', '11.5 mW','9.7 mW','4.3 mW','2.1 mW');
print -depsc 'Processed_results\ES1-C-Area1-intensities-grain_boundary-30s';
...
plot_result(MH2_GB_800mW,6,'ev','30s integrating time','MH2 B2 Area 2 - 30s integration time',fontsize,'b',3);
...
plot_result(MH2_GB_400mW,6,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'g',3);
...
plot_result(MH2_GB_220mW,6,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'c',3);
...
plot_result(MH2_GB_180mW,6,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'m',3);
...
plot_result(MH2_GB_80mW,6,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'y',3);
...
plot_result(MH2_GB_40mW,6,'ev','30s integrating time','ES1 C Area 1 - 30s integration time',fontsize,'k',3);

legend('43 mW','21 mW', '11.5 mW','9.7 mW','4.3 mW','2.1 mW');
print -depsc 'Processed_results\MH2-B2-Area2-intensities-grain_boundary-30s';
...
plot_result(MH2_clean_900mW,7,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'b',3);
...
plot_result(MH2_clean_400mW,7,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'g',3);
...
plot_result(MH2_clean_220mW,7,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'c',3);
...
plot_result(MH2_clean_180mW,7,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'m',3);
...
plot_result(MH2_clean_80mW,7,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'y',3);
...
plot_result(MH2_clean_40mW,7,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'k',3);

legend('48 mW','21.5 mW','11.5 mW','9.7 mW','4.3 mW','2.1 mW');
print -depsc 'Processed_results\MH2-B2-Area1-intensities-clean_area-30s';
...
plot_result(MH2_clean_400mW_32K,8,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'b',3);
...
plot_result(MH2_clean_400mW_44K,8,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'g',3);
...
plot_result(MH2_clean_400mW_50K,8,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'c',3);
...
plot_result(MH2_clean_400mW_60K,8,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'m',3);
...
plot_result(MH2_clean_400mW_70K,8,'ev','30s integrating time','MH2 B2 Area 1 - 30s integration time',fontsize,'k',3);


legend('32 K', '44 K', '50 K', '60 K','70 K');
print -depsc 'Processed_results\MH2-B2-Area1-tempereatures-clean_area-30s';